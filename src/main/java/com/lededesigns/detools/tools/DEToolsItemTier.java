package com.lededesigns.detools.tools;
...
public enum DEToolsItemTier implements IItemTier {
    ...
    DEToolsItemTier(int harvestLevel, int maxUses, float efficiency, float attackDamage, int enchantability, Supplier<Ingredient> repairMaterial) {
